...
export default function HeroSection({ openModalFunction }: HeroSectionProps) {
    return (
        <section className={styles.hero} id='hero'>
            <div>
                ...
                <button className={styles.agendBtn} onClick={() => { openModalFunction() }}>Agendar horário</button>
            </div>
        </section>
    )
}